...
- **Baseline edits are deletion-only.** A lane may delete lines from `allowed_str_any_mappings`; it may never add one. Adding requires the maintainer — say so in the lane's report and leave the site in place.
