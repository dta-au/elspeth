...
# /srv/elspeth and grants write access to /srv/elspeth/data.
export ELSPETH_CHECKOUT=/srv/elspeth
export ELSPETH_DATA_DIR=/srv/elspeth/data
...
sqlite3 /srv/elspeth/data/runs/audit.db ".schema token_outcomes" | grep -E "completed|path"
# Expected: both completed and path columns present.

# 2. The engine emits the new triple.
sqlite3 /srv/elspeth/data/runs/audit.db \
