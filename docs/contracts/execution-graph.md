...
| `DIVERT` | Token diverted to error/quarantine sink | Source `on_validation_failure`, transform `on_error`, config-gate `on_error` |
...
| Error divert | `"__error_{producer_name}__"` | transform_2 or quality_gate → error_sink |
