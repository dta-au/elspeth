...
## Current Cutover: 0.8.1 replica recovery, identity admission and prompt provenance (session epoch 63 and Landscape epoch 42)
...
session-epoch-63/Landscape-epoch-42 record when binding candidate and rollback
decisions.
