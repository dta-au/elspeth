...
## Current Cutover: 0.8.1 replica recovery, identity admission, prompt provenance and call mode audit (session epoch 66 and Landscape epoch 45)
...
session-epoch-66/Landscape-epoch-45 record when binding candidate and rollback
decisions.
