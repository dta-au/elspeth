...
## Current Cutover: 0.8.0 blob cleanup, guided decline, and aggregation recovery (session epoch 48 and Landscape epoch 36)

0.8.0 advances `SESSION_SCHEMA_EPOCH` from 35 to 48. Epoch 36 ensures a committed
...
An epoch-35 through epoch-47 database cannot represent
...
session-epoch-48/Landscape-epoch-36 record when binding candidate and rollback
decisions.
