...
## Current Cutover: 0.8.1 replica recovery, identity admission, prompt provenance and call mode audit (session epoch 67 and Landscape epoch 46)
...
session-epoch-67/Landscape-epoch-46 record when binding candidate and rollback
decisions.
