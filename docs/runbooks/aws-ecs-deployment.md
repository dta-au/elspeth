...
```json
{
  ...
  "schema_facts": {
    "candidate": {"session_epoch": 59, "landscape_epoch": 42, "run_web_plugin_policy_present": true},
    "previous": {"session_epoch": 35, "landscape_epoch": 29, "run_web_plugin_policy_present": true},
    "structural_changes": "session_epoch_35_to_59_landscape_epoch_29_to_42_blob_cleanup_guided_decline_row_union_barrier_and_coordination_schema",
...
session epoch 59, Landscape epoch 42 and `run_web_plugin_policy` presence,
...
not epoch 59. Pre-1.0 candidates do not migrate predecessor schemas: the old
