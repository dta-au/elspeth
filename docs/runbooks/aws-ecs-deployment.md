...
```json
{
  ...
  "schema_facts": {
    "candidate": {"session_epoch": 47, "landscape_epoch": 30, "run_web_plugin_policy_present": true},
    "previous": {"session_epoch": 35, "landscape_epoch": 29, "run_web_plugin_policy_present": true},
    "structural_changes": "session_epoch_35_to_47_landscape_epoch_29_to_30_blob_cleanup_guided_decline_and_row_union_barrier",
...
session epoch 45, Landscape epoch 30 and `run_web_plugin_policy` presence,
...
not epoch 45. Pre-1.0 candidates do not migrate predecessor schemas: the old
...
drained and repair forward with epoch-47 session/epoch-30 Landscape code.
