...
```json
{
  ...
  "schema_facts": {
    ...
    "structural_changes": "session_epoch_35_to_60_landscape_epoch_29_to_42_blob_cleanup_guided_decline_row_union_barrier_and_coordination_schema",
...
session epoch 60, Landscape epoch 42 and `run_web_plugin_policy` presence,
...
not epoch 60. Pre-1.0 candidates do not migrate predecessor schemas: the old
