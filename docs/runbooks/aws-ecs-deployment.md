...
```json
{
  ...
  "schema_facts": {
    ...
    "structural_changes": "session_epoch_35_to_66_landscape_epoch_29_to_44_blob_cleanup_guided_decline_row_union_barrier_and_coordination_schema",
...
session epoch 66, Landscape epoch 44 and `run_web_plugin_policy` presence,
