...
session epoch 49, Landscape epoch 36 and `run_web_plugin_policy` presence,
...
not epoch 49. Pre-1.0 candidates do not migrate predecessor schemas: the old
...
drained and repair forward with epoch-49 session/epoch-36 Landscape code.
