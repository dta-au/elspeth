...
```json
{
  ...
  "schema_facts": {
    "candidate": {"session_epoch": 47, "landscape_epoch": 36, "run_web_plugin_policy_present": true},
    "previous": {"session_epoch": 35, "landscape_epoch": 29, "run_web_plugin_policy_present": true},
    "structural_changes": "session_epoch_35_to_47_landscape_epoch_29_to_36_blob_cleanup_guided_decline_and_row_union_barrier",
...
session epoch 47, Landscape epoch 36 and `run_web_plugin_policy` presence,
...
the candidate has recreated Landscape at epoch 36, the 0.7.1 image must
...
drained and repair forward with epoch-47 session/epoch-36 Landscape code.
