...
```json
{
  ...
  "schema_facts": {
    "candidate": {"session_epoch": 50, "landscape_epoch": 36, "run_web_plugin_policy_present": true},
    "previous": {"session_epoch": 35, "landscape_epoch": 29, "run_web_plugin_policy_present": true},
    "structural_changes": "session_epoch_35_to_50_landscape_epoch_29_to_36_blob_cleanup_guided_decline_and_row_union_barrier",
...
session epoch 50, Landscape epoch 36 and `run_web_plugin_policy` presence,
...
not epoch 50. Pre-1.0 candidates do not migrate predecessor schemas: the old
...
drained and repair forward with epoch-50 session/epoch-36 Landscape code.
