...
session epoch 39, Landscape epoch 30 and `run_web_plugin_policy` presence,
...
not epoch 39. Pre-1.0 candidates do not migrate predecessor schemas: the old
...
drained and repair forward with epoch-39 session/epoch-30 Landscape code.
