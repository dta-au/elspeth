...
| 4 | Terraform shared-module generalization (`deployment lifecycle` × `llm backend` axes) + Scenario C — unchanged in shape by the Phase 3 rescope: the gateway sidecar is still a sidecar; ELSPETH points at it by base URL | `2026-08-09-llm-gateway-phase4-terraform-scenario-c.md` (written 2026-08-09; the "at Phase 3 close" obligation was discharged late) | Scenario A/B contract tests unchanged-green; Scenario C plans as `first + custom_gateway` |
