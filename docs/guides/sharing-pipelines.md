...
contract. The release expects `SESSION_SCHEMA_EPOCH=67` and
`SQLITE_SCHEMA_EPOCH=45`. Session epoch 29 introduced durable guided
...
A Landscape store below epoch 45 is stale and must be recreated. When
