...
`SQLITE_SCHEMA_EPOCH=31`. Session epoch 29 introduced durable guided
...
six-state vocabulary. A Landscape store below epoch 31 is stale and must be recreated. When
