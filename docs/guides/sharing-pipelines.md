...
proposal admission, retryable blob cleanup, and ordinary guided-plan decline
settlement. Landscape epoch 30 adds durable row_union barrier attribution, so a
