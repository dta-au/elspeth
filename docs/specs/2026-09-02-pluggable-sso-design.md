...
Date: 2026-09-02. Revision 2.14 (2026-09-19): design and implementation status, tracker milestone elspeth-07cd19ba73. The current schema definitions prepare an operator-owned cutover; installing code does not execute that procedure.
