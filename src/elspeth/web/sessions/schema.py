...
# Epoch 67 binds coalesce mapping-branch order and multi-source ``sources``
# order in the composer authority hashes and the advisor fingerprint. Stored
# epoch-66 hash preimages cannot be re-verified, so the store is recreated.
_COORDINATION_HARD_CUT_EPOCH = 67
