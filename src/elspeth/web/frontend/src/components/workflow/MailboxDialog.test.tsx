...
vi.mock("@/api/workflow", () => ({ fetchMailboxInbox: vi.fn(), fetchMailboxSent: vi.fn(), fetchMailboxSummary: vi.fn(), fetchWorkflowInspect: vi.fn(), decideApproval: vi.fn(), attestReview: vi.fn(), markApprovalSeen: vi.fn() }));
