...
describe("GraphView", () => {
  ...
  it("does not render or announce a legacy collector on_error edge", () => {
    ...
    expect(screen.getByTestId("edge-inferred-sink-stitch-assembled")).toBeInTheDocument();
    expect(screen.queryByTestId("edge-e-stitch-legacy_errors-0")).not.toBeInTheDocument();
    expect(screen.queryByTestId("edge-inferred-sink-stitch-legacy_errors-error")).not.toBeInTheDocument();
