...
output schemaOwnerIdentityResourceId string = environment.outputs.schemaOwnerIdentityResourceId
output schemaOwnerKeyVaultName string = environment.outputs.schemaOwnerKeyVaultName
output schemaOwnerKeyVaultUri string = environment.outputs.schemaOwnerKeyVaultUri
