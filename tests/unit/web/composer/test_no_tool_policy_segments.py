...
_BARE_SUFFIX_ROUND_TRIP_CASES = [
    ...
    pytest.param(
        no_tool_policy._ADVISOR_SIGNOFF_UNAVAILABLE_PENDING_FINALIZE_SUFFIX,
        no_tool_policy._ADVISOR_SIGNOFF_UNAVAILABLE_PENDING_NOTICE,
        id="_ADVISOR_SIGNOFF_UNAVAILABLE_PENDING_FINALIZE_SUFFIX",
    ),
    pytest.param(
        no_tool_policy._ADVISOR_SIGNOFF_MALFORMED_PENDING_FINALIZE_SUFFIX,
        no_tool_policy._ADVISOR_SIGNOFF_MALFORMED_PENDING_NOTICE,
        id="_ADVISOR_SIGNOFF_MALFORMED_PENDING_FINALIZE_SUFFIX",
    ),
    pytest.param(
        no_tool_policy._ADVISOR_SIGNOFF_UNAVAILABLE_UNVERIFIED_FINALIZE_SUFFIX,
        no_tool_policy._ADVISOR_SIGNOFF_UNAVAILABLE_UNVERIFIED_NOTICE,
        id="_ADVISOR_SIGNOFF_UNAVAILABLE_UNVERIFIED_FINALIZE_SUFFIX",
    ),
    pytest.param(
        no_tool_policy._ADVISOR_SIGNOFF_MALFORMED_UNVERIFIED_FINALIZE_SUFFIX,
        no_tool_policy._ADVISOR_SIGNOFF_MALFORMED_UNVERIFIED_NOTICE,
        id="_ADVISOR_SIGNOFF_MALFORMED_UNVERIFIED_FINALIZE_SUFFIX",
    ),
    pytest.param(
