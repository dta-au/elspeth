...
@pytest.mark.parametrize("bad_cost", [True, "0.01", -0.01, math.nan, math.inf, -math.inf, 10**400, -(10**400)])
...
@pytest.mark.parametrize("bad_usage_cost", [True, "0.01", -0.01, math.nan, math.inf, 10**400, -(10**400)])
