...
def test_blob_inline_resolutions_schema_epoch_is_41(engine) -> None:
    assert SESSION_SCHEMA_EPOCH == 41
    with engine.connect() as conn:
        assert conn.execute(text("PRAGMA user_version")).scalar_one() == 41
