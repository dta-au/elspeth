...
def test_sessions_and_composer_use_explicit_attribute_contracts() -> None:
    ...
    expected = {
        ...
        _AttributeProbe("src/elspeth/web/composer/service.py", "_capture_composer_llm_completion_fields", "getattr", "choices"),
        _AttributeProbe("src/elspeth/web/composer/service.py", "_capture_composer_llm_completion_fields", "getattr", "message"),
        _AttributeProbe("src/elspeth/web/composer/service.py", "_capture_composer_llm_completion_fields", "getattr", "content"),
        _AttributeProbe("src/elspeth/web/composer/service.py", "_capture_composer_llm_completion_fields", "getattr", "tool_calls"),
