...
def test_failure_rolls_back_identity_and_approvals_and_expires_token(engine: Engine, failure: str) -> None:
    tokens: list[str] = []
    ...
    with pytest.raises(RuntimeError, match="unavailable"):
        authority.disable_identity(actor=_actor(), identity_id="approver", reason="withdrawn", record=_fail)
    with engine.connect() as conn:
        assert (
