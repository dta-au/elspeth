...
EXPECTED_CORE_TAGS = {
    ...
    "pdf_rasterize": ("pdf", "rasterize", "image", "blob", "fan-out"),
    "reference_join": ("join", "lookup", "enrichment", "reference-data"),
...
_REQUIRED_GUIDANCE = {
    ...
    "pdf_rasterize": (("pdf", "png", "page", "aws_textract_inline_analysis"), ("text extractor", "s3")),
    "reference_join": (("business key", "reference table"), ("runtime", "second source")),
