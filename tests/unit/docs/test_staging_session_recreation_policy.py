...
def test_current_cutover_requires_live_epoch_contract_and_forbids_downgrade_repair() -> None:
    ...
    assert "0.7.2 blob cleanup, guided decline and replay, coordination, and row_union barrier" in current_cutover
    ...
    assert "bounded cleanup claims" in current_cutover
