...
Landscape epoch 32), not the design doc's stale 8/28.
"""
...
def test_runbook_uses_plan_05_epoch_and_schema_numbers() -> None:
    ...
    assert "Landscape epoch 32" in current_cutover
    ...
    # composer-parity fix). Landscape epoch 32 is the current boundary.
