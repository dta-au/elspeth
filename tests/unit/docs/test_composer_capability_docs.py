...
Landscape epoch 31), not the design doc's stale 8/28.
"""
...
def test_runbook_uses_plan_05_epoch_and_schema_numbers() -> None:
    ...
    assert "Landscape epoch 31" in current_cutover
    ...
    # composer-parity fix). Landscape epoch 31 is the current boundary.
