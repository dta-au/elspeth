...
# records changed (token-normalized old/new manifests byte-identical), then
...
EXPECTED_CASE_REGISTRY_SHA256 = "72a33f744d5ce03e12167601573ab470dfb3ade2e2d5566918c4bc814593601a"
...
EXPECTED_CASE_FIXTURE_SHA256 = {
    ...
    "retry-quarantine-discard-routed-errors:retry-success-reopen-resume": "add6f84b856bf06915c6275a005bfb4aef5ad50068f7c93038b6b7d99970ab90",
...
EXPECTED_HARNESS_EVIDENCE = (
    ...
    *(
    ...
    (
        "harness-retry-quarantine-discard-routed-errors-retry-success-reopen-resume",
...
def test_registered_cases_and_harness_references_have_exact_atomic_parity() -> None:
    ...
    assert referenced_cells == {
        ...
        **{
        ...
        "harness-retry-quarantine-discard-routed-errors-retry-success-reopen-resume": (
            ("retry-quarantine-discard-routed-errors", "recovery"),
        ),
        "harness-sink-write-pending-redrive-write-once": (
