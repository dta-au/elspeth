...
_PLACEHOLDER_ENV: dict[str, str] = {
    ...
    "AZURE_SEARCH_API_KEY": "placeholder-not-a-secret-AZURE_SEARCH_API_KEY",
    "AZURE_SEARCH_ENDPOINT": "https://placeholder-not-a-secret.search.windows.net",
    "AZURE_SEARCH_INDEX": "placeholder-not-a-secret-AZURE_SEARCH_INDEX",
