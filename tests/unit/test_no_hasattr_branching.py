...
tests/unit/contracts/test_operation_type_contract.py::hasattr(audit_contracts, 'OPERATION_TYPE_VALUES')
tests/unit/contracts/test_operation_type_contract.py::hasattr(audit_contracts, 'OperationType')
...
tests/unit/core/dag/test_wiring_boundary.py::not hasattr(dag_facade, 'WiredTransform')
tests/unit/core/dag/test_wiring_boundary.py::not hasattr(dag_models, 'WiredTransform')
tests/unit/core/landscape/test_database_ports.py::hasattr(ports, 'LandscapeConnectionProvider')
tests/unit/core/landscape/test_database_ports.py::not hasattr(_database_ops, 'LandscapeConnectionProvider')
tests/unit/core/landscape/test_exporter.py::not hasattr(read_model, 'data_flow')
tests/unit/core/landscape/test_exporter.py::not hasattr(read_model, 'execution')
tests/unit/core/landscape/test_exporter.py::not hasattr(read_model, 'query')
tests/unit/core/landscape/test_exporter.py::not hasattr(read_model, 'run_lifecycle')
tests/unit/core/landscape/test_journal.py::not hasattr(LandscapeJournal, '_parse_insert_statement')
tests/unit/core/landscape/test_journal.py::not hasattr(LandscapeJournal, '_parse_update_statement')
tests/unit/core/landscape/test_model_loaders.py::hasattr(audit_contracts, 'validate_node_state_completion_fields')
tests/unit/core/landscape/test_model_loaders.py::hasattr(audit_contracts, 'validate_node_state_persisted_fields')
tests/unit/core/landscape/test_model_loaders.py::hasattr(audit_contracts, 'validate_token_outcome_persisted_fields')
tests/unit/core/landscape/test_public_api.py::hasattr(landscape, name)
...
tests/unit/core/landscape/test_write_intent_begin.py::not hasattr(read_repos, write_attr)
tests/unit/core/security/test_secret_loader.py::not hasattr(loader, '_cache')
...
tests/unit/core/test_preflight_contract_boundary.py::hasattr(dependency_config, name)
tests/unit/core/test_preflight_contract_boundary.py::hasattr(preflight_contracts, name)
tests/unit/core/test_preflight_contract_boundary.py::not hasattr(dependency_config, name)
tests/unit/core/test_token_outcomes.py::hasattr(TokenOutcome, '__dataclass_fields__')
tests/unit/engine/orchestrator/test_phase_error_masking.py::not hasattr(event, 'error')
tests/unit/engine/orchestrator/test_types.py::not hasattr(types, 'RowProcessorHandle')
